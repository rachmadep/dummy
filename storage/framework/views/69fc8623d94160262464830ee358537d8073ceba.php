  ...
  <?php echo e(csrf_field()); ?>
    ...
    <div class="panel panel-default panel-create"> <!-- panel-create -->
        ...
        <div class="panel-body">
          ...
          <textarea name="description" class="form-control createpost-form comment" cols="30" rows="2" id="createPost" cols="30" rows="2" placeholder="<?php echo e(trans('messages.post-placeholder')); ?>"></textarea>
